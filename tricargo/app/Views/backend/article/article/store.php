						...
						<div class="form-row">
							...
							<div class="block clearfix">
								<div class="i-checks" style="width:100%;">
									<span style="color:#000;" class="uk-flex uk-flex-middle">
										<?php echo form_radio('template', set_value('template', 'frontend/article/article/lesson'), ((isset($_POST['template']) && $_POST['template'] == 'frontend/article/article/lesson' || (isset($article['template']) && $article['template'] == 'frontend/article/article/lesson')) ? true : false),'class=""   id="learn" style="margin-top:0;margin-right:10px;" '); ?>

										<label for="learn" style="margin:0;cursor:pointer;">Giao diện Tuyển dụng</label>
									</span>
								</div>
							</div>
							<?php 
