...
class Product extends FrontendController{
    ...
    public function index($id = 0, $page = 1){
        ...
        $this->data['object'] = $this->AutoloadModel->_get_where([
            'select' => 'tb1.id,tb1.price,tb1.sub_album, tb1.price_promotion,tb1.catalogueid, tb1.viewed, tb1.album, tb1.image, tb2.title, tb2.canonical,tb2.sub_album_title,tb2.made_in, tb2.meta_title, tb2.sub_title,tb2.video, tb2.shock, tb2.sub_content, tb1.productid, tb2.meta_description,  tb2.description, tb2.content, tb1.bar_code, tb1.model, tb1.brandid, tb1.articleid, tb1.icon, tb1.rate, tb3.title as brand_title',
    ...
    private function product_general($module_extract = [], $id = []){
        $product_general = $this->AutoloadModel->_get_where([
            'select' => 'tb1.catalogueid, tb3.id, tb3.price, tb3.hot, tb3.created_at,  tb3.price_promotion, tb3.image, tb2.module, tb3.rate, tb3.album,       tb2.title,tb2.description, tb2.content, tb2.canonical,  tb2.meta_title, tb2.meta_description',
