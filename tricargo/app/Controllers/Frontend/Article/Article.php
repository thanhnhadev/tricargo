...
class Article extends FrontendController{
    ...
    public function index($id = 0, $page = 1){
        ...
        $this->data['articleRelate'] = $this->AutoloadModel->_get_where([
            'select' => 'tb1.id,tb1.viewed, tb1.image,tb4.title as cat_title,tb1.catalogue, tb4.canonical as cat_canonical, tb3.title, tb3.canonical, tb3.meta_title,tb1.info, tb3.meta_description,tb3.icon, tb3.viewed, tb3.description, tb3.content, tb1.created_at, tb5.fullname',
            'table' => $module_extract[0].' as tb1',
            'where' => [
