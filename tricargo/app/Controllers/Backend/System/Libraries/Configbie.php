	...
	public function system(){
		...
		$data['contact'] =  array(
			...
			'value' => array(
				...
				'cskh' => array('type' => 'text', 'label' => 'Số điện thoại Kinh doanh'),
				'phone' => array('type' => 'text', 'label' => 'Số điện thoại Kỹ thuật'),
		...
		$data['another'] =  array(
			...
			'value' => array(
				'banner_1' => array('type' => 'images', 'label' => 'Banner chân trang 1'),
				'banner_2' => array('type' => 'images', 'label' => 'Banner chân trang 2'),
				'help' => array('type' => 'editor', 'label' => 'Hướng dẫn mua hàng'),
			),
		);
		$data['seo'] =  array(
