    ...
    public function index($id = 0, $page = 1){
        ...
        if($config['total_rows'] > 0){
            ...
            $this->data['productList'] = $this->AutoloadModel->_get_where([
                'select' => 'tb1.id,tb1.viewed,tb1.productid, tb1.image,tb1.price,tb1.rate, tb1.price_promotion,  tb1.album, tb2.title, tb2.canonical, tb2.meta_title, tb2.meta_description, tb2.module, tb2.description, tb2.content, tb1.model, tb1.bar_code',
                'table' => 'product as tb1',
                'where' => [
                    'tb1.deleted_at' => 0,
                    'tb1.publish' => 1,
