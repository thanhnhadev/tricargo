...
class Media extends BaseController{
	...
	public function update($id = 0){
		...
		$this->data[$this->data['module']] = $this->AutoloadModel->_get_where([
			'select' => 'tb1.id, tb4.title, tb4.canonical, tb4.description, tb1.iframe, tb4.content, tb4.meta_title, tb4.meta_description, tb1.catalogueid, tb1.image, tb1.album, tb1.publish, tb1.catalogue, tb4.customer, tb4.phongcach, tb4.area, tb4.brand,tb4.sub_content,tb4.sub_title',
